        ...
        <nav class="md:flex md:justify-between md:items-center">
            ...
            <div class="mt-8 md:mt-0 flex items-center">
                @auth
                    <x-drop-down>
                        <x-slot name="trigger">
                            <button href="/register" class="text-xs font-bold uppercase">Whelcome, {{auth()->user()->name}}!</button>
                        </x-slot>
                        @admin
                            <x-drop-down-item href="/admin/posts" :active="request()->is('admin/posts')">All Post</x-drop-down-item>
